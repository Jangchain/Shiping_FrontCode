<template>
  <div>
    <p
      style="background:#031e5e;padding:20px;margin:0;font-size:22px;color:#54D1FF;padding-bottom:0"
    >
      <span style="color:#fff">新建策略-</span>选择策略类型
    </p>
    ...
    <el-tabs id="tabes" type="border-card" v-model="radio" @tab-click="tabChange()">
      ...
      <el-tab-pane label="检测任务" name="task">
        <Datatable
          v-if="!activeName"
          @handleSizeChange="handleSizeChange"
          @handleCurrentChange="handleCurrentChange"
