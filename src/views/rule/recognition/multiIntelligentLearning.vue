<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="部署状态"></el-table-column>
      ...
      <el-table-column label="已处理"></el-table-column>
      <el-table-column label="未处理"></el-table-column>
...
<script>
import { multiIntelligentLearning } from "@/api/identifyModel";
export default {
  data() {
    return {
      tableData: [],
  ...
  methods: {
    search(page) {
      ...
      multiIntelligentLearning(this.searchForm)
        .then(res => {
          if (res.code === 0) {
