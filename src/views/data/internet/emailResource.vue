<template>
  <div class="data-area">
    ...
    >
      <div class="form-data">
        <div class="title-name">邮件信息源列表</div>
        <div class="title-form">
          <el-form :inline="true" :model="query">
            ...
            <el-form-item>
              <el-button type="primary" @click="gettableData(1)"
                >查询</el-button
              >
            </el-form-item>
            <el-form-item>
              <el-button type="danger" @click="gettableData(1)"
                >批量删除</el-button
              >
            </el-form-item>
            <el-form-item>
              <el-button type="success" @click="gettableData(1)"
                >新建</el-button
              >
            </el-form-item>
          </el-form>
